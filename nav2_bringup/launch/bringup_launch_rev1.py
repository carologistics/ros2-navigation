...
def generate_launch_description():
    ...
    # Constant parameters
    lifecycle_nodes_nav = ['controller_server',
                       'smoother_server',
                       'planner_server',
                       'behavior_server',
                       'bt_navigator',
    ...
    lifecycle_nodes_cm = ['collision_monitor']
    autostart = True
    ...
    configured_params_nav = RewrittenYaml(
    ...
    declare_log_level_cmd = DeclareLaunchArgument(
     ...
     # 2. Declare the launch arguments_collision control parameters
    declare_namespace_cmd = DeclareLaunchArgument(
        'namespace',
        default_value='',
        description='Top-level namespace')
    ...
    declare_params_file_cmd = DeclareLaunchArgument(
        'params_file',
        default_value=os.path.join(bringup_dir, 'params', 'collision_monitor_params.yaml'),
        description='Full path to the ROS2 parameters file to use for all launched nodes')
    ...
    load_nodes = GroupAction(
        ...
        actions=[
            ...
            Node(
                ...
                respawn=use_respawn,
                respawn_delay=2.0,
                parameters=[configured_params_nav],
